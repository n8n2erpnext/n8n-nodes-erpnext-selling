...
const sellingResources: INodePropertyOptions[] = [
	{ name: 'Customer', value: 'customer' },
	{ name: 'Lead', value: 'lead' },
	{ name: 'Opportunity', value: 'opportunity' },
	{ name: 'Quotation', value: 'quotation' },
	{ name: 'Sales Order', value: 'salesOrder' },
	{ name: 'Sales Partner', value: 'salesPartner' },
...
export class ErpNextSelling implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'ERPNext Selling',
		name: 'erpNextSelling',
		icon: 'file:erpnext-selling.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["resource"] + ": " + $parameter["operation"]}}',
		description: 'Work with ERPNext/Frappe Selling v15-v16 documents and methods',
		defaults: {
